    ...
    render() {
        ...
        return (
            <div className={`card ${!isShow ? "" : "show"}`}>
                <div class="hide" onClick={onChangeIsShow}>
                ...
                <div className="card-header">
                    <svg width="165" height="22" viewBox="0 0 106 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M66.9552 2.52896H60.5167C59.1147 2.52896 57.7701 3.08519 56.7788 4.07529C55.7874 5.06538 55.2305 6.40824 55.2305 7.80844V7.80844C55.2308 9.20854 55.7879 10.5512 56.7791 11.5412C57.7704 12.5312 59.1148 13.0876 60.5167 13.0879H66.9552" stroke="#46B2D1" stroke-width="3.5"/>
                        <path d="M68.5693 13.1159H75.0065C75.701 13.1159 76.3888 12.9792 77.0304 12.7137C77.672 12.4481 78.2549 12.0588 78.7458 11.5682C79.2367 11.0775 79.626 10.495 79.8915 9.85403C80.1569 9.21303 80.2932 8.52607 80.2927 7.83243V7.83243C80.292 6.43281 79.7347 5.09077 78.7434 4.10147C77.7521 3.11216 76.4079 2.55659 75.0065 2.55695H68.5693" stroke="#46B2D1" stroke-width="3.5"/>
                    ...
                    <span className="header-text">{text}<br />In partnership with Name company</span>
                </div>
